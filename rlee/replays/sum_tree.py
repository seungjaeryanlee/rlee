"""
Edited version of SumTree class from Google Dopamine.
...
class SumTree:
    ...
    def sample(self, query_value: float = None) -> int:
        """
    ...
    def stratified_sample(self, batch_size: int) -> List[Any]:
        """
        Perform stratified sampling using the sum tree.
    ...
    def get(self, node_index: int) -> Any:
        """
        Return the value of the leaf node corresponding to the index.
    ...
    def set(self, node_index: int, value: float) -> None:
        """
        Set the value of a leaf node and updates internal nodes accordingly.
